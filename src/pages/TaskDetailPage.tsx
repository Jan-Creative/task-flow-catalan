    ...
    <div className="relative w-full min-h-screen bg-transparent text-foreground overflow-hidden">
      ...
      <div className="relative z-20 p-4 pb-24">
        <div className="max-w-7xl mx-auto task-detail-grid">
          ...
          <div className="hidden 2xl:grid 2xl:grid-cols-5 gap-6 min-h-[600px] auto-rows-fr">
            {/* Task Details Card - Més ampla */}
            ...
            <div className="col-span-1 row-span-4 animate-fade-in" style={{animationDelay: '0.3s'}}>
          ...
          <div className="hidden xl:grid 2xl:hidden xl:grid-cols-3 gap-6 auto-rows-fr">
            ...
            {/* Segona fila amb Pomodoro */}
            <div className="col-span-3 animate-fade-in" style={{animationDelay: '0.3s'}}>
              <div className="h-full min-h-[300px]">
                <LazyPomodoroCard taskId={task.id} />
              </div>
            </div>
            ...
            <div className="col-span-3 animate-fade-in" style={{animationDelay: '0.4s'}}>
