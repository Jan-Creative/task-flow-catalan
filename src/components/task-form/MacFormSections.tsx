    ...
    <div className="grid grid-cols-12 gap-8 p-8 min-h-full">
      ...
      <div className="col-span-5 space-y-8">
        <div className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground">Detalls fonamentals de la tasca</p>
        </div>
      ...
      <div className="col-span-4 space-y-8">
        <div className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground">Estats i planificació temporal</p>
        </div>
      ...
      <div className="col-span-3 space-y-8">
        <div className="space-y-2">
          ...
          <p className="text-sm text-muted-foreground">Recordatoris i propietats personalitzades</p>
        </div>
