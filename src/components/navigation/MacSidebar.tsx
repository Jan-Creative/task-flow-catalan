  ...
  return (
    <div className={cn(
      ...
      <div className="h-full flex flex-col bg-card backdrop-blur-2xl rounded-2xl shadow-floating hover:shadow-elevated transition-shadow duration-300">
        ...
        {/* Header Section */}
        <div className={cn("p-6 space-y-4", isCollapsed && "p-3")}>
        ...
        <div className={cn("p-6", isCollapsed && "p-3")}>
          <Button
            ...
            className={cn(
              "w-full bg-primary hover:bg-primary/90 text-primary-foreground font-medium transition-all duration-200 rounded-xl group",
              isCollapsed ? "h-10 p-0" : "h-11"
            )}
        ...
        <div className="flex-1 overflow-y-auto px-3">
          {mainSections.map((section, sectionIndex) => (
            <div key={section.title} className={cn("mb-6", isCollapsed && "mb-4")}>
                ...
                {section.items.map((item) => {
                  ...
                  return (
                    <Button
                      ...
                      className={cn(
                        "w-full h-10 rounded-lg transition-all duration-200 group",
              ...
              {/* Section Separator - only show when expanded */}
