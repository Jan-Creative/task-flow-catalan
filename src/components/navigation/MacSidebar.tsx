import { Calendar, Folder, Settings, Bell, Home, CheckSquare, Sunrise, Plus } from "lucide-react";
...
const MacSidebar = ({ 
  ...
  return (
    <div className="fixed left-0 top-0 h-full w-72 z-40 p-4">
      {/* Main Sidebar Container */}
      <div className="h-full flex flex-col bg-card/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-border/50">
        ...
        <div className="p-6">
          <Button
            ...
            className="w-full bg-primary hover:bg-primary/90 text-primary-foreground font-medium transition-all duration-200 h-11 rounded-xl group"
          >
